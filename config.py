...
MAX_BACKGROUND_ASSET_BYTES = _positive_env_int(
    "AUDIOSPIDER_MAX_BACKGROUND_ASSET_BYTES", 20 * 1024 * 1024,
)
MAX_BACKGROUND_TOTAL_BYTES = _positive_env_int(
    "AUDIOSPIDER_MAX_BACKGROUND_TOTAL_BYTES", 50 * 1024 * 1024,
)
MAX_BACKGROUND_ASSETS = _positive_env_int("AUDIOSPIDER_MAX_BACKGROUND_ASSETS", 12)
BACKGROUND_ASSET_TIMEOUT = _positive_env_int(
    "AUDIOSPIDER_BACKGROUND_ASSET_TIMEOUT", 75,
)
